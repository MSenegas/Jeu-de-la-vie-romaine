...
const int FACES_DE=6;
const int MAX_ENFANTS=6;
const int INDEMNITE_SUBSTITUTION_ENFANTS=75;
const int PERIODE_CHEMIN_SUR_RISQUE=4;
const int ARGENT_INITIAL=100;
